...
% \begingroup
% \thispagestyle{empty}
% \AddToShipoutPicture*{\put(0,0){\includegraphics[scale=120]{Figures/testfront}}} % Image background
% \centering
% \vspace*{5cm}
% \par\normalfont\fontsize{35}{35}\sffamily\selectfont
% \textbf{\color{white}{Εισαγωγή στην Αστροφυσική}}\\
% {\LARGE \color{white}{Σάββας Χανλαρίδης}}\par % Book title
% \vspace*{1cm}
% {\Huge \color{white}{Σημειώσεις Μαθήματος}}\par % Author name
% \endgroup
